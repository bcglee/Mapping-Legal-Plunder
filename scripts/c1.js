...
class MapViz extends Component {
    ...
    draw() {
        ...
        var enterdots = dots.enter()
            ...
            .attr("class", "backdot")
            .attr("cx", function (d) {
                return this.initial_projection([d["lon"], d["lat"]])[0];
            })
            .attr("cy", function (d) {
                return this.initial_projection([d["lon"], d["lat"]])[1];
            })
            .attr("r", function(d) {
            ...
            .on("mouseover", function(d){return this.tooltip.style("visibility", "visible")
                                                    .text(d["town"]);})
            //.on("mouseover", function(d){return tooltip.text("TEST");})
            .on("mousemove", function(){return this.tooltip.style("top", (event.pageY-10)+"px").style("left",(event.pageX+10)+"px");})
